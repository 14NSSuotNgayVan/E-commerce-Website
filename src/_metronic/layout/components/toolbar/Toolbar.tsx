      ...
      if (toolbarElement) {
        ...
        if (appToolbarSwapEnabled) {
          for (const key in appToolbarSwapAttributes) {
            if (Object.prototype.hasOwnProperty.call(appToolbarSwapAttributes, key)) {
        ...
        if (appToolbarStickyEnabled) {
          for (const key in appToolbarStickyAttributes) {
            if (Object.prototype.hasOwnProperty.call(appToolbarStickyAttributes, key)) {
        ...
        if (appToolbarMinimizeEnabled) {
          for (const key in appToolbarMinimizeAttributes) {
            if (Object.prototype.hasOwnProperty.call(appToolbarMinimizeAttributes, key)) {
