...
import { deleteCategory, searchCategory } from "./services/CategoryServices";
import TableCustom from "../component/table-custom/TableCustom";

function Category() {
    const intl = useIntl();
    const { lang } = useMultiLanguage();
    const title = "GENERAL.CATEGORY";
    ...
    return (
        <div className="spaces my-40">
            ...
            <CategoryModal isShowModal={isShowModal} handleCloseModal={handleCloseModal} handleSearch={handleSearch} item={item} />
        </div>
    );
}
